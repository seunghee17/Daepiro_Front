...
class _$MyPageStateImpl implements _MyPageState {
  _$MyPageStateImpl(
      ...
      this.realName = '',
      this.nickName = '',
      this.communityAlarmState = true,
      this.disasterAlarmState = true,
...
abstract class _MyPageState implements MyPageState {
  factory _MyPageState(
      ...
      final bool isArticleLoading}) = _$MyPageStateImpl;

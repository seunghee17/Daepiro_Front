...
import 'package:daepiro/presentation/home/main/un_normal_home_screen.dart';
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  //                                                 GestureDetector(
  //                                                   onTap: () {
  //                                                     ref.read(homeStateNotifierProvider.notifier).selectCheckList(selectedActionTipType, index);
  //                                                   },
  //                                                   child: ActionTipItem(

...
class _OnboardingService implements OnboardingService {
  ...
  Future<OnboardingInfoResponse> sendOnboardingInfo(
    ...
    _data.addAll(onboardingInfoRequest.toJson());
    final _options = _setStreamType<OnboardingInfoResponse>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OnboardingInfoResponse _value;
    try {
      _value = OnboardingInfoResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
